<div class="container-fluid">
    <a href="/controllers/dashboard/dungeons/donjons_dash_controller.php">
        ...
        <div class="col-8">
            <form method="POST" enctype="multipart/form-data" id="myForm">
                ...
                <div class="mb-3 row my-5">
                    ...
                    <div class="col-sm-8">
                        <input type="file" class="form-control picture" name="picture_dungeons" id="picture">
