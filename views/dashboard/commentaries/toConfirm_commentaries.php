<div class="container-fluid" id="page-container-footer">
                ...
                <tbody class="table-group-divider">
                    ...
                    foreach ($getToConfirmCommentarie as $toConfirmCommentarie) { ?>
                        <tr class="text-center">
                            ...
                            <td class="text-break"><?php echo $toConfirmCommentarie->text ?></td>
                            ...
                            <td class="d-flex justify-content-evenly">
                                <a href="/controllers/dashboard/commentaries/toConfirm_commentaries_controller.php?action=confirm&id_comments=<?= $toConfirmCommentarie->id_comments ?>">
                                    <button class="btn btn-transparent svg-btn" title="Valider l'élément">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" id="btn-annuler" data-bs-dismiss="modal">Annuler</button>
                                                    <a id="confirmDeleteButton" href="/controllers/dashboard/commentaries/toConfirm_commentaries_controller.php?action=delete&id_comments=<?= $toConfirmCommentarie->id_comments ?>" class="btn btn-danger">Confirmer la suppression</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <button class="btn btn-transparent svg-btn" title="Supprimer l'élément" data-bs-toggle="modal" data-bs-target="#confirmationModal">
