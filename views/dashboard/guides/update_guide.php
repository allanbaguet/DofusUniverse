<div class="container-fluid">
    ...
    <h1 class="text-center">Modification de page guide</h1>
    <div class="row my-5">
        <div class="col-2"></div>
        <div class="col-8">
            <form method="POST" enctype="multipart/form-data" id="myForm">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control titleDj" id="main_title" name="main_title" value="<?=$guideObj->main_title?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control titleDj" id="main_text" name="main_text" value="<?=$guideObj->main_text?>">
                ...
                <div class="mb-3 row my-5">
                    ...
                    <div class="col-sm-8">
                        <div class="mb-5">
                            <img class="img-fluid" src="/public/uploads/guides/<?= $guideObj->picture_guides ?>" alt="image guide">
                        </div>
                ...
                <div class="mb-3 row my-5">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control description" name="description" id="description" value="<?=$guideObj->description?>"></textarea>
