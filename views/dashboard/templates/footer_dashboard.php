<footer id="footer-dashboard">
    ...
    <script src="/public/assets/js/script_dungeon.js"></script>
    <!-- appel du script en question concernant la modal du confirm delete user -->
    <script src="<?= $modalDelete ?>"></script>
