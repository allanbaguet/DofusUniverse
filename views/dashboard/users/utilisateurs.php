                            ...
                            <tr class="text-center">
                                ...
                                <td class="d-flex justify-content-evenly">
                                    <a href="/controllers/dashboard/users/update_utilisateurs_controller.php?id_users=<?= $userList->id_users ?>">
                                        <button class="btn btn-transparent svg-btn" title="Modifier l'élément">
                        ...
                        foreach ($getUserArchived as $userArchived) { ?>
                            <tr class="text-center">
                                ...
                                <td class="d-flex justify-content-evenly">
                                    ...
                                    <button type="button" class="btn btn-transparent svg-btn delete-button" title="Supprimer l'élément" data-bs-toggle="modal" data-bs-target="#confirmationModal">
