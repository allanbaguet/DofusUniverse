...
<div class="container-fluid">
    <div class="row pt-3 justify-content-center align-items-center">
        <div class="col-lg-6 col-md-8 col-sm-10">
            ...
            <p class="fs-5 pb-4 pt-2 text-end border-top border-4">Donjon crée par <span id="title-card-white">admin,</span> dernière modification le <?= date('d-m-Y', strtotime($getDungeonList->modified_at)) ?></p>
        </div>
    </div>
</div>
