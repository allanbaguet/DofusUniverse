<header>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2 p-3 rounded fs-5 mt-3 mb-5 bgColorText">
                <p>Dofus est un géant dans l’univers vidéoludique français. Le jeu a marqué les cours de récré et l’imaginaire de toute une génération, via ses produits dérivés, son univers ou directement sa version MMO, le premier pour la plupart. Il n’y a pas besoin de préciser que son gameplay est niche, avec une ambiance proprement Ankama. Mais si vous hésitez à rejoindre l’aventure, il vaut le coup d’œil. Ne serait qu’un plaisir d’un soir, Dofus est un jeu à découvrir, aimer et/ou détester. C’est une expérience, une dose gratuite à prendre et très difficile à quitter. Outre le gameplay clairement unique, l’histoire à découvrir mérite votre attention, avec un bon sentiment d’accomplissement au fil de votre progression.</p>
            </div>
        </div>
    </div>
</header>
